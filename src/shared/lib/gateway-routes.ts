...
export const PROJECT_ROUTES = {
  ...
  contractAmendments: (projectId: string) => `${COLLAB_API}/collab/projects/${projectId}/contract/amendments`,
  contractAmendmentsRequest: (projectId: string) => `${COLLAB_API}/collab/projects/${projectId}/contract/amendments/request`,
  contractAmendmentRequestSignature: (projectId: string, amendmentId: string) =>
    `${COLLAB_API}/collab/projects/${projectId}/contract/amendments/${amendmentId}/request-signature`,
  contractAmendmentSign: (projectId: string, amendmentId: string) =>
    `${COLLAB_API}/collab/projects/${projectId}/contract/amendments/${amendmentId}/sign`,
...
export const MARKETING_ROUTES = {
  ...
  proposals: `${API_PREFIX}/marketing/proposals`,
  proposal: (id: string | number) => `${API_PREFIX}/marketing/proposals/${id}`,
  proposalsByClient: (clientId: string) => `${API_PREFIX}/marketing/proposals/client/${clientId}`,
  proposalsByStatus: (status: string) => `${API_PREFIX}/marketing/proposals/status/${status}`,
  proposalStatus: (id: string | number) => `${API_PREFIX}/marketing/proposals/${id}/status`,
  clients: `${API_PREFIX}/marketing/clients`,
  clientsWithoutPlan: `${API_PREFIX}/marketing/clients/sin-plan`,
  clientsByPlan: (plan: string) => `${API_PREFIX}/marketing/clients/plan/${plan}`,
  clientPlan: (clientId: string) => `${API_PREFIX}/marketing/clients/${clientId}/plan`,
  clientPlansBulk: `${API_PREFIX}/marketing/clients/plans`,
  interactions: `${API_PREFIX}/marketing/interactions`,
  interaction: (id: string | number) => `${API_PREFIX}/marketing/interactions/${id}`,
  interactionsByCampaign: (campaignId: string | number) => `${API_PREFIX}/marketing/interactions/campaign/${campaignId}`,
  interactionsByClient: (clientId: string) => `${API_PREFIX}/marketing/interactions/client/${clientId}`,
  interactionResponse: (id: string | number) => `${API_PREFIX}/marketing/interactions/${id}/response`,
  segmentPreview: `${API_PREFIX}/marketing/segments/preview`,
  segmentExecute: (workflowId: string | number) => `${API_PREFIX}/marketing/segments/${workflowId}/execute`,
  schedulerRun: `${API_PREFIX}/marketing/scheduler/run`,
  integrationSync: `${API_PREFIX}/integration/sync`,
} as const
...
export const ANALYTICS_ROUTES = {
  ...
  kpisCurrent: `${API_PREFIX}/analytics/kpis/current`,
  kpisCalculate: `${API_PREFIX}/analytics/kpis/calculate`,
  kpisByPeriod: (period: string) => `${API_PREFIX}/analytics/kpis/period/${period}`,
  kpisHistory: `${API_PREFIX}/analytics/kpis/history`,
